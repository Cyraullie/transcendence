export default function PrivacyPolicyClean() {
  return (
    <div className="page-content mt-17 text-justify">
      ...
      <div className="intro">
        <p>
          {" "}
          This Privacy Notice for Popcode Inc ( '<strong>we</strong>', '
        ...
        <p>
          ...
          <a className="link" href="mailto:popcorn.coders@gmail.com">
      ...
      <div className="pp-summary">
        ...
        <p>
          ...
          do not collect any information from third parties. <br />
          <br />
          ...
          <strong>
            {" "}
            In what situations and with whichparties do we share personal
            information?
          </strong>{" "}
          We may share information in specific situations and with specificthird
          parties. Learn more aboutwhen and with whom we share your personal
          information.
          <br />
          <br />
        </p>
        <p>
          ...
          adequateorganisationaland technical processes and procedures in place
          to protect your personal information. However, no electronic
          transmission over the internet or information storage technology can
          be guaranteed to be 100% secure, so we cannot promise or guarantee
          that hackers, cybercriminals, or otherunauthorisedthird parties will
          not be able to defeat our security and improperly collect, access,
          steal, or modify your information. Learn more about{" "}
          <a href="#PrivacyRight">how we keep your information safe.</a> <br />
          <br />
        </p>
        <p>
	  ...
	  <br/>
        ...
        <ol className="list-decimal ms-8">
          <li className="link-hover">
            <a href="#informationCollected">WHAT INFORMATION DO WE COLLECT?</a>
          </li>
          <li className="link-hover">
            <a href="#informationProcess">
          ...
          <li className="link-hover">
            <a href="#sharePersonal">
              WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?
            </a>
          </li>
          <li className="link-hover">
            <a href="#cookiesTracker">
              DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
            </a>
          </li>
          <li className="link-hover">
            <a href="#socialLogin">HOW DO WE HANDLE YOUR SOCIAL LOGINS</a>
          </li>
          <li className="link-hover">
            <a href="#keepInformationLong">
              HOW LONG DO WE KEEP YOUR INFORMATION
            </a>
          </li>
          <li className="link-hover">
            <a href="#keepInformationSafe">
          ...
          <li className="link-hover">
            <a href="#controlsTrack">CONTROLS FOR DO-NOT-TRACK FEATURES</a>
          </li>
          <li className="link-hover">
            <a href="#usResidents">
          ...
          <li className="link-hover">
            <a href="#makeUpdates">DO WE MAKE UPDATES TO THIS NOTICE</a>
          </li>
          <li className="link-hover">
      ...
      <div id="informationCollected" className="mt-17">
        <h2 className="text-center">
        ...
        <p>
          ...
          the section called{" "}
          <a href="#socialLogin" className="link">
      ...
      <div className="cookiesTracker" id="cookiesTracker">
        ...
        <p>
          ...
          <a className="link" href="#usResidents">
      ...
      <div className="socialLogins" id="socialLogin">
        <h2 className="text-center">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
        <p>
          <br />
      ...
      <div className="keepInformationLong" id="keepInformationLong">
        <h2 className="text-center">
      ...
      <div className="keepInformationSafe" id="keepInformationSafe">
        <h2 className="text-center">
      ...
      <div className="privacyRights" id="privacyRights">
        <h2 className="text-center">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <br />
        <p>
          ...
          <a href="https://www.edoeb.admin.ch/en" className="link">
        ...
        <p>
          ...
          legal terms and/or comply with applicable legal requirements. <br />
          <br />
          ...
          email us at{" "}
          <a href="mailto:popcorn.coders@gmail.com" className="link">
            popcorn.coders@gmail.com.
          </a>
        </p>
        <br />
      ...
      <div className="controlsTrack" id="controlsTrack">
        <h2 className="text-center">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        <br />
        <p>
      ...
      <div id="usResidents">
        ...
        <br />
        <h3 className="text-center">Sources of Personal Information</h3>
        <br />
        <p>
        ...
        <p>
          ...
          <a href="#informationProcess" className="link">
            HOW DO WE PROCESS YOUR INFORMATION?
          </a>
          <br />
          <br />
          ...
          section,{" "}
          <a href="#sharingPersonnalData" className="link">
            WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?
          </a>
          <br />
          <br />
        ...
        <h3 className="text-center">Your Rights</h3>
		<br/>
        <p>
        ...
        <ul className="list-disc ms-8">
          ...
          <li>
            <strong>Right to correct</strong> naccuracies in your personal data
          </li>
          <li>
